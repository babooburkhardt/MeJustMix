...
fun SaveColorDialog(
    ...
    val library by mixViewModel.library.collectAsState()
    val lastUsedFolderName by mixViewModel.lastUsedFolderName.collectAsState()
    ...
    BlurManagedDialog(
        ...
        Card {
            Column(
                ...
                Text("Save Color", style = androidx.compose.material3.MaterialTheme.typography.titleLarge)
